...
//                            zhangjieEntity.setShujiId(Integer.valueOf(data.get(0)));   //小说 要改的
//                            zhangjieEntity.setZhangjieName(data.get(0));                    //章节名称 要改的
//                            zhangjieEntity.setZhangjieContent("");//照片
//                            zhangjieEntity.setPaixu(Integer.valueOf(data.get(0)));   //排序 要改的
