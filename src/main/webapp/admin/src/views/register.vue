    ...
    <div>
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">小说阅读平台注册</h1>
                <el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
                        ...
                        <el-form-item label="作者身份证号" class="input" v-if="tableName=='zuozhe'">
                            <el-input v-model="ruleForm.zuozheIdNumber" autocomplete="off" placeholder="作者身份证号"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.zuozheIdNumber)&& 'zuozhe'==this.tableName){
                                this.$message.error('作者身份证号不能为空');
                                return
                            }
                            if('zuozhe' == this.tableName && this.ruleForm.yonghuEmail&&(!this.$validate.isEmail(this.ruleForm.yonghuEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                this.$http({
