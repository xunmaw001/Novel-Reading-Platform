  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='zuozhe'"  label='作者身份证号' prop="zuozheIdNumber">
               <el-input v-model="ruleForm.zuozheIdNumber"  placeholder='作者身份证号' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='zuozhe'"  label='电子邮箱' prop="yonghuEmail">
               <el-input v-model="ruleForm.yonghuEmail"  placeholder='电子邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.zuozheIdNumber)&& 'zuozhe'==this.flag){
                         ...
                         if((!this.ruleForm.zuozhePhoto)&& 'zuozhe'==this.flag){
                             ...
                             if( 'zuozhe' ==this.flag && this.ruleForm.yonghuEmail&&(!isEmail(this.ruleForm.yonghuEmail))){
                                 this.$message.error(`邮箱应输入邮箱格式`);
                                 return
                             }
