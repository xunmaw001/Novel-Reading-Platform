            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='zuozhe'">
                    <el-form-item class="select" v-if="type!='info'"  label="作者" prop="zuozheId">
                        <el-select v-model="ruleForm.zuozheId" filterable placeholder="请选择作者" @change="zuozheChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='zuozhe' ">
                    <el-form-item class="input" v-if="type!='info'"  label="作者身份证号" prop="zuozheIdNumber">
                        <el-input v-model="zuozheForm.zuozheIdNumber"
                                  placeholder="作者身份证号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="作者身份证号" prop="zuozheIdNumber">
                            <el-input v-model="ruleForm.zuozheIdNumber"
                                      placeholder="作者身份证号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                ...
                <el-col :span="12"  v-if="sessionTable !='zuozhe' ">
                    <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="yonghuEmail">
                        <el-input v-model="zuozheForm.yonghuEmail"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="小说名称" prop="shujiName">
                       <el-input v-model="ruleForm.shujiName"
                                 placeholder="小说名称" clearable  :readonly="ro.shujiName"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="小说类型" prop="shujiTypes">
                        <el-select v-model="ruleForm.shujiTypes" placeholder="请选择小说类型">
                            <el-option
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="小说简介" prop="shujiContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shujiContent" label="小说简介" prop="shujiContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shujiPhoto: [
                              { required: true, message: '小说封面不能为空', trigger: 'blur' },
                          ],
                   shujiTypes: [
                   ...
                   shujiContent: [
                              { required: true, message: '小说简介不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='zuozheId'){
                          this.ruleForm.zuozheId = obj[o];
                          this.ro.zuozheId = true;
                          continue;
                      }
                      if(o=='shujiName'){
                          this.ruleForm.shujiName = obj[o];
                          this.ro.shujiName = true;
                          continue;
                      }
                      if(o=='shujiPhoto'){
                          this.ruleForm.shujiPhoto = obj[o];
                          this.ro.shujiPhoto = true;
                          continue;
                      }
                      if(o=='shujiTypes'){
                          this.ruleForm.shujiTypes = obj[o];
                          this.ro.shujiTypes = true;
                          continue;
                      }
                      if(o=='shujiClicknum'){
                          this.ruleForm.shujiClicknum = obj[o];
                          this.ro.shujiClicknum = true;
                          continue;
                      }
                      if(o=='shangxiaTypes'){
                      ...
                      if(o=='shujiContent'){
                          this.ruleForm.shujiContent = obj[o];
                          this.ro.shujiContent = true;
                          continue;
                      }
                      if(o=='insertTime'){
            ...
            info(id) {
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        this.zuozheChange(data.data.zuozheId)
                        //解决前台上传图片后台不显示的问题
