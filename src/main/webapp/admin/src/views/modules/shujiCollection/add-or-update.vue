            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="shujiCollectionTypes">
                        <el-select v-model="ruleForm.shujiCollectionTypes" placeholder="请选择类型">
                            <el-option
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shujiCollectionTypes'){
                          this.ruleForm.shujiCollectionTypes = obj[o];
                          this.ro.shujiCollectionTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
