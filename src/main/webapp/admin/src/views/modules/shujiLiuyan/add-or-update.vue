...
<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='shuji' && sessionTable !='zuozhe'">
                    <el-form-item class="select" v-if="type!='info'"  label="小说" prop="shujiId">
                        <el-select v-model="ruleForm.shujiId" filterable placeholder="请选择小说" @change="shujiChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='shuji' ">
                    <el-form-item class="input" v-if="type!='info'"  label="小说名称" prop="shujiName">
                        <el-input v-model="shujiForm.shujiName"
                                  placeholder="小说名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="小说名称" prop="shujiName">
                            <el-input v-model="ruleForm.shujiName"
                                      placeholder="小说名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24" v-if="sessionTable !='shuji' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shujiPhoto" label="小说封面" prop="shujiPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (shujiForm.shujiPhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shujiPhoto" label="小说封面" prop="shujiPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.shujiPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='shuji' ">
                    <el-form-item class="input" v-if="type!='info'"  label="小说类型" prop="shujiValue">
                        <el-input v-model="shujiForm.shujiValue"
                                  placeholder="小说类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="小说类型" prop="shujiValue">
                ...
                <el-col :span="12"  v-if="sessionTable !='shuji' ">
                    <el-form-item class="input" v-if="type!='info'"  label="点击次数" prop="shujiClicknum">
                        <el-input v-model="shujiForm.shujiClicknum"
                                  placeholder="点击次数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="点击次数" prop="shujiClicknum">
                            <el-input v-model="ruleForm.shujiClicknum"
                                      placeholder="点击次数" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='yonghu' && sessionTable !='zuozhe' ">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="shujiLiuyanText">
                        <el-input type="textarea"  :readonly="ro.shujiLiuyanText" v-model="ruleForm.shujiLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shujiLiuyanText" label="留言内容" prop="shujiLiuyanText">
                            <span v-html="ruleForm.shujiLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shujiId'){
                          this.ruleForm.shujiId = obj[o];
                          this.ro.shujiId = true;
                          continue;
                      }
                      if(o=='yonghuId'){
                      ...
                      if(o=='shujiLiuyanText'){
                          this.ruleForm.shujiLiuyanText = obj[o];
                          this.ro.shujiLiuyanText = true;
                          continue;
                      }
                      if(o=='replyText'){
            ...
            info(id) {
                this.$http({
                    url: `shujiLiuyan/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.ruleForm = data.data;
                        this.shujiChange(data.data.shujiId)
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shujiLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shujiLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
