               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="作者身份证号" prop="zuozheIdNumber">
                       <el-input v-model="ruleForm.zuozheIdNumber"
                                 placeholder="作者身份证号" clearable  :readonly="ro.zuozheIdNumber"></el-input>
                   </el-form-item>
                   <div v-else>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   zuozheIdNumber: [
                              { required: true, message: '作者身份证号不能为空', trigger: 'blur' },
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='zuozheName'){
                          this.ruleForm.zuozheName = obj[o];
                          this.ro.zuozheName = true;
                          continue;
                      }
                      if(o=='zuozhePhone'){
                          this.ruleForm.zuozhePhone = obj[o];
                          this.ro.zuozhePhone = true;
                          continue;
                      }
                      if(o=='zuozheIdNumber'){
                          this.ruleForm.zuozheIdNumber = obj[o];
                          this.ro.zuozheIdNumber = true;
                          continue;
                      }
                      if(o=='zuozhePhoto'){
                          this.ruleForm.zuozhePhoto = obj[o];
                          this.ro.zuozhePhoto = true;
                          continue;
                      }
                      if(o=='sexTypes'){
